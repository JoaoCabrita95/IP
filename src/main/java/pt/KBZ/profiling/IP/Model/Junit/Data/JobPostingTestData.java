...
public class JobPostingTestData {
	...
	public JobPostingTestData() {
		...
		JobPosting tmp = new JobPosting("Job1", "Solutions Architect", "no comment", "Solutions Architect Description", "full_time",
		...
		tmp.setCity("city 1");
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Project Manager");
	
		JPs.add(tmp);
		
		tmp = new JobPosting("Job2", "Software Engineer", "JobPosting Comment 2", "Development of Software products", "contract",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Backend Developer");
				
				
		JPs.add(tmp);
		
		tmp = new JobPosting("Job3", "Data Scientist", "JobPosting Comment 3", "Job Description 3", "contract",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Frontend Developer");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job4", "Frontend Developer", "JobPosting Comment 4", "Job Description 4", "temporary",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Database Developer");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job5", "Data Scientist", "JobPosting Comment 5", "Job Description 5", "volunteer",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Hardware Engineer");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job6", "Programmer", "JobPosting Comment 6", "Job Description 6", "internship",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Data Analyst");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job7", "Developer", "JobPosting Comment 7", "Job Description 7", "contract",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Data Engineer");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job8", "PHP Senior Developer", "JobPosting Comment 8", "Job Description 8", "part_time",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Machine Learning Engineer");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job9", "Backend developer", "JobPosting Comment 9", "Job Description 9", "contract",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Network Architect");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job10", "Test JobPosting 10", "JobPosting Comment 10", "Job Description 10", "contract",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Devops Engineer");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job11", "Test JobPosting 11", "JobPosting Comment 11", "Job Description 11", "contract",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Security Engineer");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job12", "Test JobPosting 12", "JobPosting Comment 12", "Job Description 12", "contract",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Web Developer");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job18763218", "Data scientist", "Job Post for a university in Colorado", "Need someone to do xyz", "contract", "Data Science",
				"Science Team Leader", "Merquer inc", "USCL", "City Z in Colorado",
				"01-01-20", "31-05-20", "senior_level", null, null, "27",null,null,null, null);
		
		tmp.setCity("city 1");
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Mobile Developer");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job12987681", "AVG Construction Team Coordinator", "Manage a team of workers building AVG automatons for factory work",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("QA Engineer");
		
		JPs.add(tmp);
		
		tmp = new JobPosting("Job198273817", "Salary manager for Company X", "Company X requires a salary manager urgently",
		...
		tmp.setState("State 1");
		tmp.setCountry("Country 1");
		tmp.setSpecialization("Business Analyst");
...
//				null, null, null, null, null, null, null, null));
	...
	public void addCompetenceReq() {
		...
		for(JobPosting jp: JPs) {
			for(Skill skill : skillsData.getSkillsForJobPostings(jp.getID()))
			jp.addSkillRef(skill, null, null);
		}
	}
